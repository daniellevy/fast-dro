...
from imagenet_dataset_utils import (check_integrity,
                                    download_url,
                                    download_and_extract_archive,
                                    extract_archive, verify_str_arg)

PRIVATE_URL = 'http://www.image-net.org/challenges/LSVRC/2012/PUT-YOUR-KEY-HERE/'

ARCHIVE_DICT = {
    'train': {
        'url': PRIVATE_URL + 'ILSVRC2012_img_train.tar',
        'md5': '1d675b47d978889d74fa0da5fadfb00e',
    },
    'val': {
        'url': PRIVATE_URL + 'ILSVRC2012_img_val.tar',
        'md5': '29b22e2961454d5413ddabcf34fc5622',
    },
    'devkit': {
        'url': PRIVATE_URL + 'ILSVRC2012_devkit_t12.tar.gz',
